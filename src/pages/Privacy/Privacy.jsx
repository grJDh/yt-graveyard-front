...
const Privacy = () => {
  return (
    <div className="privacy-container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to YouTube Graveyard.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to YouTube Graveyard, accessible from{" "}
            <a
              href="https://grjdh.github.io/yt-graveyard-front/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://grjdh.github.io/yt-graveyard-front/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: rusmukhametov@gmail.com</li>
      </ul>
    </div>
  );
};
